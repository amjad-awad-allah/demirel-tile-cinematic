...
const TileGrid = () => {
  const tiles = useMemo(() => {
    const result = [];
const colors = [
  'hsl(35 40% 95%)', // بيج فاتح دافئ
  'hsl(30 35% 94%)', // عاجي مائل للخُوخ
  'hsl(40 45% 96%)', // بيج مائل للأصفر
  'hsl(0 20% 97%)',  // رمادي وردي فاتح جدًا
  'hsl(0 15% 98%)',  // أبيض رمادي فاتح
  'hsl(25 30% 96%)'  // بيج طبيعي فاتح
];
