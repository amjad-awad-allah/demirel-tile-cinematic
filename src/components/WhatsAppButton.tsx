  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999]">
      ...
      <div
        ...
        style={{
          backgroundColor: '#25D366', // نفس اللون الرسمي للخلفية
          opacity: 0.4,
          filter: 'blur(12px)',
        }}
      ></div>
      ...
      <Button
        ...
        className="relative w-16 h-16 rounded-full flex items-center justify-center p-0 transition-all duration-300
                   shadow-lg hover:scale-110 hover:bg-[#128C7E]"
        style={{
          backgroundColor: '#25D366', // اللون الأخضر الرسمي للواتس
